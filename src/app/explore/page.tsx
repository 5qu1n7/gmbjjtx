          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center justify-between gap-4 mb-4">
              <div>
                ...
                <h1 className="text-3xl font-bold text-gray-900">Explore Positions & Techniques</h1>
                <p className="text-gray-600 mt-2">Browse all 30 positions and 196 techniques</p>
              </div>
            </div>
          ...
          {filteredPositions.length > 0 ? (
            <div className="space-y-4">
              {filteredPositions.map((position) => {
                ...
                return (
                  <div key={position.id} className="border border-gray-200 rounded-lg overflow-hidden bg-white">
                                ...
                                <div className="flex items-start justify-between gap-4">
                                  ...
                                  {videoId && (
                                    <button
                                      ...
                                      className="px-4 py-2 rounded-lg bg-red-600 text-white text-sm font-medium hover:bg-red-700 transition whitespace-nowrap"
                                    >
                                      ▶ Watch
                                    </button>
                                  )}
