...
export const curriculumCategories: Category[] = [
  {
    ...
    color: "red",
    techniques: [
      { id: 200, name: "Rear Naked Choke (RNC)", description: "Most dominant submission from back control", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=J5gLJ3eC0Hc" },
      { id: 201, name: "Guillotine Choke", description: "Arm-around-neck choke from guard or clinch", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=lWXpWg3mNNo" },
      { id: 202, name: "Triangle Choke", description: "Legs used as arms to choke opponent", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=bsZ8xSJhP1E" },
      { id: 203, name: "Cross Collar Choke (Gi)", description: "Traditional gi collar choke using both lapels", type: "attack", beltRequired: "white", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=qB6d1RGE6RQ" },
      { id: 204, name: "Armbar", description: "Hyperextend elbow joint - fundamental arm lock", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=V0G3w6FBg90" },
      { id: 205, name: "Kimura", description: "Shoulder lock using figure-four grip", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=hT8YWL_qTe0" },
      { id: 206, name: "Americana", description: "Shoulder lock from top position", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=5bSEJ4rP4xg" },
      { id: 207, name: "D'arce Choke", description: "Arm-triangle choke variation", type: "attack", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=Ykbq7R3_NG0" },
      { id: 208, name: "Straight Ankle Lock", description: "Basic foot lock targeting ankle joint", type: "attack", beltRequired: "purple", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=qJfIWGHSHtw" },
      { id: 209, name: "Knee Bar", description: "Leg lock targeting knee joint", type: "attack", beltRequired: "brown", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=z4T6v0rRsqI" },
  ...
  },
  {
    ...
    color: "blue",
     techniques: [
      { id: 215, name: "Mount Escape - Bridge and Roll", description: "Basic bridge and roll escape from mount", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=HXW9hAz0Sp0" },
      { id: 216, name: "Mount Escape - Elbow Escape", description: "Shrimp and frame to escape mount", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=0LhLQbKmVVM" },
      { id: 217, name: "Side Control Escape - Shrimp", description: "Create space and recover guard from side control", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=HgKC7jJcNWE" },
      { id: 218, name: "Side Control Escape - Knee to Elbow", description: "Frame and recover half guard or full guard", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=p9J3WLQ2hPc" },
      { id: 219, name: "Kesa Gatame Escape", description: "Hip escape and guard recovery from scarf hold", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=lJTdB-eEBnQ" },
      ...
      { id: 221, name: "Knee on Belly Escape", description: "Escape pressure from knee on belly position", type: "escape", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=0dxFhKWJLkI" },
      { id: 222, name: "Back Control Escape - Roll", description: "Roll away from back control to side control", type: "escape", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=MLfVZkOPkpQ" },
      { id: 223, name: "Turtle Guard Escape - Shoulder Roll", description: "Roll out of turtle to recover guard", type: "escape", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=j6XNdZEZuqA" },
      { id: 224, name: "Guard Escape - Leg Lock Defense", description: "Defend against leg lock and recover", type: "escape", beltRequired: "purple", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=qJfIWGHSHtw" },
      { id: 225, name: "RNC Escape - Palming the Head", description: "Defend rear naked choke by palming head", type: "escape", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=J5gLJ3eC0Hc" },
      { id: 226, name: "Armbar Escape - Hand on Chest", description: "Defend armbar with proper hand positioning", type: "escape", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=V0G3w6FBg90" },
     ]
  },
  {
    id: 103,
    ...
    color: "green",
     techniques: [
      { id: 227, name: "Hip Bump Sweep", description: "Basic sit-up sweep from closed guard", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=d8hZdMWmN8w" },
      { id: 228, name: "Scissor Sweep", description: "Sweep using legs in scissor motion", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=3H3FgCAyA7s" },
      { id: 229, name: "Flower Sweep (Pendulum)", description: "Arm and leg sweep variation", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=p5JhKbQMKo8" },
      { id: 230, name: "De La Riva Sweep", description: "Sweep using DLR hook and collar grip", type: "attack", beltRequired: "purple", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=Oj5bPV8J_s4" },
      { id: 231, name: "Lasso Sweep", description: "Sweep using lasso sleeve and collar control", type: "attack", beltRequired: "blue", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=T-Fh4v0GPME" },
      { id: 232, name: "Spider Guard Sweep", description: "Sweep using spider leg control", type: "attack", beltRequired: "blue", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=YhCsN3SAcTg" },
      { id: 233, name: "X-Guard Sweep", description: "Lift and dump from X-guard position", type: "attack", beltRequired: "purple", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=CKmMN3Byk8w" },
      { id: 234, name: "Butterfly Sweep", description: "Hook and sweep from butterfly hooks", type: "attack", beltRequired: "blue", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=4v_1GFY4Aq4" },
      { id: 235, name: "Reverse De La Riva Sweep", description: "Sweep using RDR hook positioning", type: "attack", beltRequired: "purple", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=aGCVGPKZB14" },
   ...
   },
   {
     ...
     color: "purple",
     techniques: [
       { id: 237, name: "Knee Slice Pass", description: "Drive knee through to pass open guard", type: "attack", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=zRE79VgfAkk" },
       { id: 238, name: "Toreando Pass", description: "Bull-fighter pass using sleeve grips", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=XvYKKVwJdKw" },
       { id: 239, name: "Leg Drag Pass", description: "Drag legs across to establish side control", type: "attack", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=DbFyJ76bvKc" },
       { id: 240, name: "Stack Pass", description: "Stack opponent and drive through guard", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=q4yGkFKOCxo" },
       { id: 241, name: "Over-Under Pass", description: "Over-under body lock guard pass", type: "attack", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=ywJlV1agTxM" },
       { id: 242, name: "DLR Pass", description: "Pass De La Riva guard", type: "attack", beltRequired: "purple", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=KGjVs92S1No" },
       { id: 243, name: "50/50 Pass", description: "Pass 50/50 guard safely", type: "attack", beltRequired: "brown", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=qJfIWGHSHtw" },
       { id: 244, name: "Knee Cut from Headquarters", description: "Knee slice pass from headquarters position", type: "attack", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=bFgQ0mBdh5s" },
       { id: 245, name: "Backstep Pass", description: "Backstep around legs to complete pass", type: "attack", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=GcP1qBCG6Bc" },
     ]
   },
   {
     id: 105,
     ...
     color: "amber",
     techniques: [
       { id: 246, name: "Mount Pressure & Control", description: "Maintain mount with proper weight distribution", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=qYNiLvAHgWU" },
       { id: 247, name: "Side Control Pressure", description: "Apply pressure and prevent escape from side", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=3cC8kHNGUvc" },
       { id: 248, name: "Back Control Seatbelt Grip", description: "Secure back control with seatbelt position", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=MLfVZkOPkpQ" },
       ...
       { id: 250, name: "Knee on Belly Control", description: "Pressure and control from knee on belly", type: "drill", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=nQC9Bq2tWP8" },
       { id: 251, name: "Kesa Gatame (Scarf Hold) Control", description: "Maintain pressure from scarf hold position", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=lJTdB-eEBnQ" },
       { id: 252, name: "Guard Headquarters Control", description: "Maintain control in headquarters position", type: "drill", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=bFgQ0mBdh5s" },
       { id: 253, name: "Crab Ride Control", description: "Back harness control from crab ride position", type: "drill", beltRequired: "purple", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=MLfVZkOPkpQ" },
     ]
   },
   {
     id: 106,
     ...
     color: "cyan",
     techniques: [
       { id: 254, name: "Closed Guard Frame", description: "Frame and maintain distance in closed guard", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=dRdCvzE6VO0" },
       { id: 255, name: "Open Guard Distance Management", description: "Control distance to prevent pass", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=jQ6TkHXSHWE" },
       { id: 256, name: "Half Guard Hip Block", description: "Block passing leg with hip and frame", type: "drill", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=c6D7YOueLEo" },
       { id: 257, name: "Z Guard Setup", description: "Establish Z guard to prevent pass", type: "transition", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=T1B3tLcX6GQ" },
       { id: 258, name: "Knee Shield Defense", description: "Use knee shield to stop guard pass", type: "drill", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=jQ6TkHXSHWE" },
       { id: 259, name: "De La Riva Guard Retention", description: "Maintain DLR against pass attempts", type: "drill", beltRequired: "purple", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=Oj5bPV8J_s4" },
       { id: 260, name: "Spider Guard Distance Control", description: "Keep distance with spider hooks", type: "drill", beltRequired: "blue", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=YhCsN3SAcTg" },
     ]
   },
   {
     id: 107,
     ...
     color: "rose",
     techniques: [
       { id: 261, name: "Straight Ankle Lock Setup", description: "Basic ankle lock from bottom position", type: "attack", beltRequired: "purple", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=qJfIWGHSHtw" },
       { id: 262, name: "50/50 Leglock Entry", description: "Enter 50/50 position for leg lock attacks", type: "transition", beltRequired: "purple", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=z4T6v0rRsqI" },
       { id: 263, name: "Ashi Garami Position", description: "Fundamental leg lock control position", type: "drill", beltRequired: "purple", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=qJfIWGHSHtw" },
       { id: 264, name: "Knee Bar Setup", description: "Transition to knee bar from various positions", type: "attack", beltRequired: "brown", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=z4T6v0rRsqI" },
       ...
       { id: 266, name: "Toe Hold", description: "Figure-four foot lock", type: "attack", beltRequired: "brown", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=4Y0B4xg5fPs" },
       { id: 267, name: "X-Guard Footlock", description: "Foot lock setup from X-guard", type: "attack", beltRequired: "purple", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=qJfIWGHSHtw" },
       { id: 268, name: "Kneereap Leglock", description: "Attack knee with reaping motion", type: "attack", beltRequired: "brown", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=z4T6v0rRsqI" },
       { id: 269, name: "Leg Lock Defense", description: "Escape leg lock positions safely", type: "escape", beltRequired: "purple", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=RQ_m2LHvgQs" },
     ]
   },
   {
     id: 108,
     ...
     color: "indigo",
     techniques: [
       { id: 270, name: "Double Leg Takedown", description: "Basic wrestling double leg", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=8L0Jgv-7chQ" },
       { id: 271, name: "Single Leg Takedown", description: "Wrestling single leg takedown", type: "attack", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=PH7f9oUXHVw" },
       { id: 272, name: "Osoto Gari", description: "Judo major outer reap", type: "attack", beltRequired: "blue", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=PxqVN2zb7zI" },
       { id: 273, name: "Seoi Nage", description: "Judo shoulder throw", type: "attack", beltRequired: "purple", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=BI_3PrT-mDo" },
       { id: 274, name: "Takedown Defense - Sprawl", description: "Defend takedowns with proper sprawl", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=J2c2q4ySpDI" },
       { id: 275, name: "Takedown Defense - Whizzer", description: "Use underhook for takedown defense", type: "escape", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=PH7f9oUXHVw" },
       { id: 276, name: "High Crotch Takedown", description: "Wrestling high crotch takedown", type: "attack", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=8L0Jgv-7chQ" },
       { id: 277, name: "Foot Sweep Takedown", description: "Judo-style foot sweep from collar tie", type: "attack", beltRequired: "blue", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=PxqVN2zb7zI" },
     ]
   },
   {
     id: 109,
     ...
     color: "lime",
     techniques: [
       { id: 278, name: "Mount to Side Control", description: "Transition from mount to side control", type: "transition", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=qYNiLvAHgWU" },
       { id: 279, name: "Side Control to Mount", description: "Move from side control to mounted position", type: "transition", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=3cC8kHNGUvc" },
       { id: 280, name: "Guard to Back Control", description: "Transition from guard to back control", type: "transition", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=QsPCVATTJUI" },
       { id: 281, name: "Back Control to Mount", description: "Transition from back to mount", type: "transition", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=MLfVZkOPkpQ" },
       { id: 282, name: "Guard to Half Guard", description: "Move to half guard position", type: "transition", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=c6D7YOueLEo" },
       { id: 283, name: "Half Guard to Full Guard", description: "Recover full guard from half guard", type: "transition", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=dRdCvzE6VO0" },
   ...
   },
   {
     ...
     color: "sky",
     techniques: [
       { id: 288, name: "Bridge Hold Drill", description: "Basic bridge from mount for escape power", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=HXW9hAz0Sp0" },
       { id: 289, name: "Hip Escape Reps", description: "Shrimp movement repetition drill", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=0LhLQbKmVVM" },
       { id: 290, name: "Frame Drill", description: "Proper framing technique repetition", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=dRdCvzE6VO0" },
       { id: 291, name: "Guard Maintenance Drill", description: "Stay safe and control distance in closed guard", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=jQ6TkHXSHWE" },
       { id: 292, name: "Mount Pressure Drill", description: "Apply proper weight and pressure from mount", type: "drill", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=qYNiLvAHgWU" },
       { id: 293, name: "Back Control Hook Placement", description: "Practice proper hook positioning on back", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=MLfVZkOPkpQ" },
       { id: 294, name: "Collar and Sleeve Control Drill", description: "Establish and maintain collar-sleeve grips", type: "drill", beltRequired: "white", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=T-Fh4v0GPME" },
       { id: 295, name: "Spider Leg Control Drill", description: "Maintain proper spider leg positioning", type: "drill", beltRequired: "blue", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=YhCsN3SAcTg" },
       { id: 296, name: "Butterfly Hook Drill", description: "Practice butterfly hook placement and control", type: "drill", beltRequired: "blue", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=4v_1GFY4Aq4" },
     ]
   },
   {
     id: 111,
     ...
     color: "fuchsia",
     techniques: [
       { id: 297, name: "Counter to Guard Pass - Leg Lock", description: "Attack the leg when opponent passes", type: "attack", beltRequired: "purple", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=qJfIWGHSHtw" },
       ...
       { id: 299, name: "Counter to Mount Escape - Finish", description: "Finish mount when opponent tries to escape", type: "attack", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=qYNiLvAHgWU" },
       { id: 300, name: "Counter to Armbar - Hand Position", description: "Defend armbar with proper hand positioning", type: "escape", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=V0G3w6FBg90" },
       { id: 301, name: "Counter to Triangle - Stack & Pass", description: "Counter triangle by stacking and passing", type: "escape", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=bsZ8xSJhP1E" },
       { id: 302, name: "Counter to Sweep - Head Control", description: "Prevent sweep by maintaining head control", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=d8hZdMWmN8w" },
       { id: 303, name: "Counter to RNC - Chin Tuck", description: "Defend RNC by tucking chin properly", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=J5gLJ3eC0Hc" },
     ]
   },
   {
     id: 112,
     ...
     description: "Fundamental BJJ principles and positioning theory",
      color: "violet",
     techniques: [
       { id: 304, name: "Base and Posture", description: "Fundamental principles of maintaining base", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=qYNiLvAHgWU" },
       { id: 305, name: "Weight Distribution", description: "Proper weight distribution in top positions", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=3cC8kHNGUvc" },
       { id: 306, name: "Distance Management", description: "Control distance to prevent passes", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=jQ6TkHXSHWE" },
       { id: 307, name: "Grip Fighting", description: "Control and break opponent grips", type: "drill", beltRequired: "white", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=T-Fh4v0GPME" },
       { id: 308, name: "Hip Positioning", description: "Use hips as primary lever for power", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=d8hZdMWmN8w" },
       { id: 309, name: "Timing and Tempo", description: "Read opponent's timing to set up attacks", type: "drill", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=3H3FgCAyA7s" },
       { id: 310, name: "Collar Grip Importance", description: "Understand the power of collar control", type: "drill", beltRequired: "white", trainingType: "gi", videoUrl: "https://www.youtube.com/watch?v=qB6d1RGE6RQ" },
     ]
   },
   {
     id: 113,
     ...
     color: "orange",
     techniques: [
       { id: 311, name: "Survival from Mount", description: "Survive and avoid submission from mount", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=HXW9hAz0Sp0" },
       { id: 312, name: "Survival from Back Control", description: "Survive RNC and back attacks safely", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=0LhLQbKmVVM" },
       { id: 313, name: "Survival from Side Control", description: "Frame, breathe, and recover from heavy side", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=HgKC7jJcNWE" },
       { id: 314, name: "Leg Lock Survival", description: "Tap early and understand leg lock dangers", type: "drill", beltRequired: "white", trainingType: "no-gi", videoUrl: "https://www.youtube.com/watch?v=RQ_m2LHvgQs" },
       { id: 315, name: "North-South Survival", description: "Survive and escape north-south pressure", type: "escape", beltRequired: "blue", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=nPie9yUU4LM" },
       { id: 316, name: "Defend Guillotine - Posture", description: "Keep posture to defend guillotine choke", type: "escape", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=lWXpWg3mNNo" },
       { id: 317, name: "Defend Chokes - Neck Positioning", description: "Protect neck when in danger of choke", type: "drill", beltRequired: "white", trainingType: "both", videoUrl: "https://www.youtube.com/watch?v=J5gLJ3eC0Hc" },
     ]
   },
 ];
